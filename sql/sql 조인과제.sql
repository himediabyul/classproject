...
select ename as "사원이름" , job as "업무", deptno as "부서번호", dname as "부서명"
from emp natural join dept
where loc = 'NEW YORK';


--38. SELF JOIN을 사용하여 사원의 이름 및 사원번호, 관리자 이름을 출력하시오.
select e1.ename as "사원이름" , e1.empno as "사원번호", e2.ename as "관리자이름"
from emp e1, emp e2
...
select e2.ename as "사원이름", e2.hiredate as "입사일"
from emp e1, emp e2
where e1.ename = 'WARD'
...
select e1.ename as "사원이름" , e1.hiredate as "입사일" , e2.ename as "관리자이름", e2.hiredate as "입사일"
from emp e1, emp e2
where e1.mgr = e2.empno
