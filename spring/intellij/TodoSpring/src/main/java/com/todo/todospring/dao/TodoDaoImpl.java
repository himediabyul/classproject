...
public class TodoDaoImpl implements TodoDao {
    ...
    public List<TodoDTO> selectAll(Connection conn) throws SQLException {
        ...
        @Cleanup PreparedStatement pstmt = conn.prepareStatement("Select * from todo");
    ...
    public TodoDTO selectByTno(Connection conn, long tno) throws SQLException {
        ...
        @Cleanup PreparedStatement pstmt = conn.prepareStatement("Select * from todo where tno=?");
        pstmt.setLong(1, tno);
        @Cleanup ResultSet rs = pstmt.executeQuery();
    ...
    public int insertToDo(Connection conn, TodoDTO dto) throws SQLException {
        ...
        int result = 0;
        String sql = "insert into todo (todo, dueDate) values (?, ?)";
