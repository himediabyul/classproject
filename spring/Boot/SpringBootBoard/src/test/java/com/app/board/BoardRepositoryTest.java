...
//        BoardWriteRequest -> Entity - save()
    ...
    public void findIdTest(){
        ...
        // view 페이지, edit form
        Optional<Board> result = boardRepository.findById(100);

        Board board = result.get();

        log.info("100번 게시물 >>> " + board);
    }
    ...
    public void deleteTest(){
        ...
        int result = boardRepository.deleteByBno(107);
        log.info(">>>>>> 결과 >>>>>>" + result);
