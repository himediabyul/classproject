...
public class SmartPhone2 extends Computer implements SmartDevice {
	...
	public void call() {
		...
		System.out.println(number1 + number1 + number9 + "에 전화를 겁니다");
	...
	public static void main(String[] args) {
		...
		SmartPhone2 phone = new SmartPhone2("hi@google.com");
