...
public class Member {
	...
	public static void main(String[] args) {
	 ...
	 - 대한민국 성인( 20세 )의 경우 무료로 
	 - 2년마다 건강검진을 받을 수 있습니다.
	 - 짝수 해에 태어난 사람은 올해가 짝수년이라면 검사 대상이 됩니다. : 태어난해의 %2의 결과 값과 올해 년의 %2 한 값이 일치한다
		...
		public static void checkMedical(int birthYear) {
			...
			if (age>=20) {
					...
					if(currYear%2 == birthYear%2) {
						System.out.println("무료검진이 가능합니다.");
						
						if (age>=40) {
							System.out.println("암 검사도 무료로 진행합니다.");
						}
					} else {
						System.out.println("무료검진 대상이 아닙니다.");
					}
			}else {
				System.out.println("20세 미만은 무료검진 대상이 아닙니다.");
			}
