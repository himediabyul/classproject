...
public class CustomerContact1 extends Contact {
...
//	 - 정보를 출력하는 메소드를 오버라이딩 해서 추가된 정보를 추가해서 출력
	...
	public CustomerContact1(String name, String phoneNumber, String email, 
	...
	public String toString() {
		return "CustomerContact1 [company=" + company + ", product=" + product + ", position=" + position + "]";
	}
