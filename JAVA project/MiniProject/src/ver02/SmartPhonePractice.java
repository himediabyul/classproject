...
public class SmartPhonePractice {
	...
	private  SmartPhonePractice(int size){
	...
	static SmartPhonePractice sp = new SmartPhonePractice(10);
		
	public static SmartPhonePractice getInstance() {
		
		if(sp==null) {
			sp = new SmartPhonePractice(10);
		}
		return sp;
	}
