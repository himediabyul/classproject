...
public class SmartPhone {
	...
	//이름을 입력받고 배열에서 해당 이름의 Contact 객체가 있는 index를 반환
	...
	void editContact() {
		...
		if(contact instanceof CompanyContact) {
			...
			System.out.println("변경하고자 하는 직급을 입력해주세요(현재값:" +companyContact.getManager()+"\n"+"변경하지 않으려면 엔터를 치세요");
